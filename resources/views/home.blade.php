            ...
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Kami merindukan mu, Kamu memiliki <span
                            class="text-primary">{{ $barang }} Barang Untuk Dibandingkan</span></h6>
                </div>
        ...
        <div class="col-md-6 grid-margin transparent">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-light-blue">
                        <div class="card-body">
                            <p class="mb-4">Gudang</p>
                            <p class="fs-30 mb-2">{{ $gudang}}</p>
                            <p> Lokasi Gudang</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-xl-12 d-flex flex-column justify-content-start">
                                        <div class="ml-xl-4 mt-3">
                                            ...
                                            <h1 class="text-primary">Pemilihan Barang</h1>
                                            ...
                                            <p class="mb-2 mb-xl-0">Pada aplikasi ini, dibuat untuk memudahkan pengguna
                                                ketika memiliki studi kasus dalam meilih barang, sistem ini dibuat
